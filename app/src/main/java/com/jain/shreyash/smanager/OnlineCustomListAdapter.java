...
public class OnlineCustomListAdapter extends ArrayAdapter {
    ...
    public OnlineCustomListAdapter(Activity context, String[] offline_cancel_date, String[] offline_day_week, Boolean[] ck_breakfast_offline, Boolean[] ck_lunch_offline, Boolean[] ck_dinner_offline){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.online_list_row, null,true);
